...
export default function TusDatosCard() {
  ...
  return (
    <div
      className="min-h-[100svh] flex flex-col items-center justify-start gap-6 px-5 sm:px-8 py-6 sm:py-10"
      style={{ background: "linear-gradient(180deg, #ffffff 0%, #e6f1ff 100%)" }}
    >
      {/* Progress bar arriba, centrada */}
      <div className="w-full">
        <ProgressBar current={0} /> {/* Paso 0 = Información personal */}
      </div>
      ...
      >
        ...
        <div className={fieldWrap}>
          ...
          <div className="relative">
            <span className={icon} aria-hidden>
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                <path d="M22 16.92v2a2 2 0 0 1-2.18 2 19.8 19.8 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6A19.8 19.8 0 0 1 2.08 4.2 2 2 0 0 1 4.06 2h2" stroke="currentColor" strokeWidth="1.6" />
              </svg>
            </span>
